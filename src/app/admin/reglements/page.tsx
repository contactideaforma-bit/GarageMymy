  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-white/45">
        Règles appliquées : prime de signature à la 2e mensualité payée, bonus engagement avec elle, reprise si résiliation avant la 3e (la prime de fidélité est à 0 dans la grille v1.2) ; chargé de mission payé pour chaque mensualité encaissée : heures du forfait × son taux horaire (17 €/h par défaut). Les bonus de volume trimestriels se saisissent en ligne manuelle.
      </p>
