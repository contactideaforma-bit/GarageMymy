  ...
  return (
    ...
    >
      ...
      <section className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <Tuile titre="Marge avant commercial / mois" valeur={euros(r.margeAvantCommercialMensuelle)} sous={`après ${euros(r.retrocessionsMensuelles)} de chargés de mission (${euros(p.tauxHoraireSecretaire)}/h) et ${euros(r.techniqueMensuel)} de technique`} />
      ...
      <section className="glass-card overflow-hidden">
          ...
          <table className="w-full min-w-[56rem] text-sm">
            <thead className="text-white/50">
              ...
              <tr className="text-left">
                ...
                <th className="cellule text-right font-medium">− Chargé de mission</th>
        ...
        <p className="px-4 py-3 text-xs text-white/45">
          Bloc « Chaque mois » : ce que le garage paie chaque mois, moins le chargé de mission (heures du forfait × {euros(p.tauxHoraireSecretaire)}/h) et le coût technique ({euros(p.coutTechnique)} / garage).
      ...
      {paramsOuverts && (
        <section className="glass-card p-4 sm:p-5">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            <Param label="Chargé de mission : taux horaire" value={p.tauxHoraireSecretaire} suffixe="€/h" onChange={(v) => setP({ ...p, tauxHoraireSecretaire: v })} />
