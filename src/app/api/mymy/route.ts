...
Pages utiles : "/" tableau de bord, "/sinistres" liste des dossiers, "/import" nouveau dossier, "/factures", "/finance" paiements & relances, "/planning", "/agenda", "/annuaire", "/vehicules", "/flotte" flotte du garage (fiche véhicule, prêts/locations, qui avait le véhicule à une date), "/rentabilite", "/emails", "/courriers" courriers papier envoyés par La Poste (lettre simple, recommandé AR via Maileva), "/profil".
